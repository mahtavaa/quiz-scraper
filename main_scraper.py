...
from scraper_utilities import (createSession, login, construct_url, get_questionpage, 
	make_soup, find_all_questionrows, find_question_number, find_question, find_tags, 
	find_image, find_answer, sleep_randomly, create_category_dictionary,
	is_valid_category, compute_pages_for_category, validate_end_page,
	validate_start_page)
...
if is_valid_category(CATEGORY, category_dict):

	pages_for_category = compute_pages_for_category(CATEGORY, category_dict)
	end_page = validate_end_page(TO_PAGE, pages_for_category)
	start_page = validate_start_page(FROM_PAGE, end_page)
